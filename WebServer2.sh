...
wp core download --version=3.9 # Download WordPress Core
...
wp core install --url="http://$IP" --title="Assignment 2 WordPress Server 2" --admin_user="group_1" --admin_password="alpha wario salamander" --admin_email="test@test.co.nz" # Install WordPress and set up our user
